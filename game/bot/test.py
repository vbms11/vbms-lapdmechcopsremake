...
import math
from math import degrees, atan2, asin, acos, sin, cos, radians
...
def makeVec (x,y):
    ...
    nx = (sin(radians(x)) * cos(radians(y))) * radiusOfEarthKM
    ny = (cos(radians(x)) * cos(radians(y))) * radiusOfEarthKM
    nz = sin(radians(y)) * radiusOfEarthKM
    return Vec3(nx,ny,nz)

# willibald platz
location2 = makeVec(11.4888883,48.1406463)

# laimer platz
location1 = makeVec(11.4987588,48.1355933)

print "vec1: ", location1
print "radius of earth: ", location1.length()

print "vec2: ", location2
print "radius of earth: ", location2.length()

vec = Vec3(location1.x - location2.x, location1.y - location2.y, location1.z - location2.z)
